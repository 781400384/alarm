...
/////////////////////////////////////////////////////////////////////////////
        ...
        if (NSFoundationVersionNumber > NSFoundationVersionNumber_iOS_7_1) {
            ...
            UIAlertController * ac = [UIAlertController alertControllerWithTitle:@"Good morning"
                                                                         message:@"It's not me that wake you up every day, it's a dream"
            ...
            UIAlertView *av = [[UIAlertView alloc] initWithTitle:@"Good morning" message:@"It's not me that wake you up every day, it's a dream" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
